...
### 8-2. 카카오 로그인 — ✅ 완료 (2026-08-08)

- **현황**: 끝났다. **로그인은 카카오·구글 둘뿐이다** — 이메일은 2026-08-07에 명세에서 빠졌고
  대시보드의 Email 프로바이더도 껐다.
- **여기 적어 둔 예상이 맞았다**: "사람이 직접 해야 한다"던 콘솔 준비가 작업의 전부였고,
  **코드는 한 줄도 안 고쳤다**(2026-08-07 소셜 전환 때 이미 다 붙어 있었다).
- **마이그레이션**: 없음
- 자세히는 `backlog.md` §1-2와 `note.md`의 "카카오 로그인 개통".
